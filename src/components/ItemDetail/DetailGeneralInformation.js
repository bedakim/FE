      ...
      <ScrollableAnchor id={'section4'} activeTab={this.props.activeTab}>
        <section className="detail-section">
          <Collapse title="배민찬 새벽배송 지역안내">
            ...
            <Table className="delivert-tb" bordered>
              <thead>
                <tbody>
                  <tr>
                  ...
                  <tr>
                    <th rowspan="48">경기도</th> <th>구리시</th>
                    <td>-</td> <td class="c2">불가능</td>
                    <td class="c2">전 지역</td>
                  </tr>
                  <tr>
                    <th>부천시</th>
                  ...
                  <tr>
                    <td rowspan="2">단원구</td> <td>가능</td>
                    <td>
                      와동, 고잔동, 신길동, 원곡동, 초지동, 선부동, 화정동
                    </td>
                  </tr>
                  <tr>
                    <td class="c2">불가능</td>
                  ...
                  <tr>
                    <th rowspan="6">성남시</th> <td rowspan="2">분당구</td>
                    <td>가능</td>
                    <td>
                  ...
                  <tr>
                    <th rowspan="6">수원시</th> <td rowspan="2">권선구</td>
                    <td>가능</td>
                    <td>
                  ...
                  <tr>
                    <th rowspan="5">용인시</th> <td rowspan="2">기흥구</td>
                    <td>가능</td>
                    <td>
                  ...
                  <tr>
                    ...
                    <td class="c2">
                      ...
                      산남동, 당하동, 송촌동, 하지석동, 서패동, 신촌동,
                      연다산동, 금릉동, 문산읍, 파주읍, 법원읍, 조리읍, 월롱면,
                      탄현면, 광탄면, 파평면, 적성면, 군내면, 장단면, 진동면,
                      진서면
                    </td>
                  </tr>
                  <tr>
                  ...
                  <tr>
                    <td rowspan="2">계양구</td> <td>가능</td>
                    <td>
                      효성1동, 효성2동, 계산1동, 계산2동, 작전동, 서운동,
                      임학동, 용종동, 병방동, 방축동, 박촌동, 동양동, 귤현동,
                      장기동
                    </td>
                  </tr>
                  <tr class="c3">
                  ...
                  <tr>
                    <td>강화군</td> <td class="c2">불가능</td>
                    <td class="c2">전 지역</td>
                  </tr>
                  <tr>
                    <td>옹진군</td> <td class="c2">불가능</td>
                    <td class="c2">전 지역</td>
                  </tr>
                  <tr>
